...
export const COMPARISON_VIEWS = ["dial", "wrist", "oblique", "side", "lugtop", "lug", "seconds", "back", "rake", "strapedge", "loopside", "crown3", "hardware", "hardwareback", "backdetail", "wear", "wearside", "closure", "strapopen"] as const;
